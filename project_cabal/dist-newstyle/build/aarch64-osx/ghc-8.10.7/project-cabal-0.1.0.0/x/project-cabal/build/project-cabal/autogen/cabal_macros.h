...
/* package project-cabal-0.1.0.0 */
#ifndef VERSION_project_cabal
#define VERSION_project_cabal "0.1.0.0"
#endif /* VERSION_project_cabal */
#ifndef MIN_VERSION_project_cabal
#define MIN_VERSION_project_cabal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_project_cabal */
...
#define CURRENT_COMPONENT_ID "project-cabal-0.1.0.0-inplace-project-cabal"
